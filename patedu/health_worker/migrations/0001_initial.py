...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('health_worker_healthworker', (
            ('user_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
            ('Post', self.gf('django.db.models.fields.CharField')(default='ASHA', max_length=6)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('health_worker', ['HealthWorker'])


    def backwards(self, orm):
        # Deleting model 'HealthWorker'
        db.delete_table('health_worker_healthworker')
