...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LOGUICL'
        db.create_table('common_loguicl', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('operator_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('benef_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('address', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('lmp_date', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('date_tt1', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('facility_current', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('facility_past', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('action', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('common', ['LOGUICL'])


    def backwards(self, orm):
        # Deleting model 'LOGUICL'
        db.delete_table('common_loguicl')
    ...
    models = {
        ...
        'common.loguicl': {
            'Meta': {'object_name': 'LOGUICL'},
            'action': ('django.db.models.fields.TextField', [], {}),
            'address': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'benef_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'date': ('django.db.models.fields.CharField', [], {'max_length': '12'}),
            'date_tt1': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'facility_current': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'facility_past': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lmp_date': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'operator_name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        'common.nhmtargets': {
