...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IMMReportings.measles_date'
        db.alter_column('common_immreportings', 'measles_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'IMMReportings.measles_date'
        raise RuntimeError("Cannot reverse this migration. 'IMMReportings.measles_date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'IMMReportings.measles_date'
        db.alter_column('common_immreportings', 'measles_date', self.gf('django.db.models.fields.DateField')())
