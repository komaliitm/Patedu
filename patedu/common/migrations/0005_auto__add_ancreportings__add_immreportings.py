...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ANCReportings'
        db.create_table('common_ancreportings', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('benef', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mcts_identities.ANCBenef'], unique=True)),
            ('anc1_date', self.gf('django.db.models.fields.DateField')(null=True)),
            ('anc2_date', self.gf('django.db.models.fields.DateField')(null=True)),
            ('anc3_date', self.gf('django.db.models.fields.DateField')(null=True)),
            ('anc4_date', self.gf('django.db.models.fields.DateField')(null=True)),
            ('delivery_date', self.gf('django.db.models.fields.DateField')(null=True)),
        ))
        db.send_create_signal('common', ['ANCReportings'])

        # Adding model 'IMMReportings'
        db.create_table('common_immreportings', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('benef', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mcts_identities.IMMBenef'], unique=True)),
            ('measles_date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('common', ['IMMReportings'])


    def backwards(self, orm):
        # Deleting model 'ANCReportings'
        db.delete_table('common_ancreportings')

        # Deleting model 'IMMReportings'
        db.delete_table('common_immreportings')
    ...
    models = {
        ...
        'common.immreportings': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'measles_date': ('django.db.models.fields.DateField', [], {})
        },
        'common.nhmtargets': {
