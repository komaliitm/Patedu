...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExotelCallStatus'
        db.create_table('common_exotelcallstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('subcenter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mcts_identities.SubCenter'], null=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('uid', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('role', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ('mode', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ('recording_url', self.gf('django.db.models.fields.TextField')(null=True)),
            ('date_initiated', self.gf('django.db.models.fields.DateField')(null=True)),
            ('dt_updated', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('common', ['ExotelCallStatus'])


    def backwards(self, orm):
        # Deleting model 'ExotelCallStatus'
        db.delete_table('common_exotelcallstatus')
