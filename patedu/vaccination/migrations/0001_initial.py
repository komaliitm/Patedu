...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Vaccinations'
        db.create_table('vaccination_vaccinations', (
            ('vaccineId', self.gf('django.db.models.fields.CharField')(max_length=50, primary_key=True)),
            ('VaccineName', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('AgeInWeeks', self.gf('django.db.models.fields.IntegerField')()),
            ('notes', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('vaccination', ['Vaccinations'])

        # Adding model 'VaccinationBeneficiary'
        db.create_table('vaccination_vaccinationbeneficiary', (
            ('BeneficiaryId', self.gf('django.db.models.fields.CharField')(max_length=30, primary_key=True)),
            ('ChildName', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('Sex', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('NotifyNumber', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('VerificationCode', self.gf('django.db.models.fields.IntegerField')(max_length=50)),
            ('Dob', self.gf('django.db.models.fields.DateField')()),
            ('isVerified', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('isScheduleGenerated', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('health_worker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['health_worker.HealthWorker'], null=True)),
            ('Gaurdian_name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('Language', self.gf('django.db.models.fields.CharField')(default='HIN', max_length=16)),
            ('CreatedOn', self.gf('django.db.models.fields.DateTimeField')()),
            ('ModifiedOn', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('vaccination', ['VaccinationBeneficiary'])

        # Adding model 'VaccineReminderTemplate'
        db.create_table('vaccination_vaccineremindertemplate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('Vaccine', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vaccination.Vaccinations'])),
            ('stage', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('Language', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('sms_message', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('ivr_message', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('email_message', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
        ))
        db.send_create_signal('vaccination', ['VaccineReminderTemplate'])

        # Adding model 'SMSMessages'
        db.create_table('vaccination_smsmessages', (
            ('msg_identifier', self.gf('django.db.models.fields.CharField')(max_length=64, primary_key=True)),
            ('msg', self.gf('django.db.models.fields.CharField')(max_length=640)),
        ))
        db.send_create_signal('vaccination', ['SMSMessages'])

        # Adding model 'VaccineReminder'
        db.create_table('vaccination_vaccinereminder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('vaccine_reference', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vaccination.VaccineReminderTemplate'])),
            ('vaccination_beneficiary', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vaccination.VaccinationBeneficiary'])),
            ('state', self.gf('django.db.models.fields.IntegerField')(default=2)),
            ('errorCode', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True)),
            ('dueDate', self.gf('django.db.models.fields.DateField')()),
            ('vaccDate', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('vaccination', ['VaccineReminder'])


    def backwards(self, orm):
        # Deleting model 'Vaccinations'
        db.delete_table('vaccination_vaccinations')

        # Deleting model 'VaccinationBeneficiary'
        db.delete_table('vaccination_vaccinationbeneficiary')

        # Deleting model 'VaccineReminderTemplate'
        db.delete_table('vaccination_vaccineremindertemplate')

        # Deleting model 'SMSMessages'
        db.delete_table('vaccination_smsmessages')

        # Deleting model 'VaccineReminder'
        db.delete_table('vaccination_vaccinereminder')
