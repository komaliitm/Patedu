...
EXOTEL_SID = 'dlpmcs'
EXOTEL_TOKEN = '103dc5b7c0ea1c594438466a3632f039584047ce'
EXOTEL_APP_URL = "http://my.exotel.in/exoml/start/47979"
EXOTEL_CALLERID = "01130017630"
...
MEDIA_ROOT = os.path.join(PROJECT_DIR, 'mcts_data/media')

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash.
# Examples: "http://media.lawrence.com/media/", "http://example.com/media/"
#MEDIA_URL = '/upfiles/'
MEDIA_URL = '/mcts_data/media/'
