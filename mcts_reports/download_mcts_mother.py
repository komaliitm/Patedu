                ...
                for phc in phc_list:
                    ...
                    for subc in subc_list:
                        __VS5, __EV5, village_list = get_token(br=br, event_target="CmbSubCentre", tsm1="UP14|CmbSubCentre", \
                            client_token_vs=__VS4, client_token_ev=__EV4, report_type=report_type, year=fin_year, month=fin_month, mother=benef_type,block=block,phc=phc,subcenter=subc)
                        for ticker in range(1,3):
                            try:
                                ...
                                #Generate report
                                report_uri = "http://nrhm-mctsrpt.nic.in/MCHRPT/Report/Report_Resistration.aspx?rpt="+benef_tag+"&"+gid_param
                                try:
